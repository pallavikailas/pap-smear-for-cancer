...
# def get_data(data_dir='C:\\Users\\admin\\Desktop\\FcvProject\\Herlev Datase\\train\\carcinoma_in_situ', distances=[5], angles=[0]):
#     data, labels = [], []
...
#     data_dir = 'C:\\Users\\admin\\Desktop\\FcvProject\\Herlev Datase\\train\\carcinoma_in_situ'
#     distances = [5]
#     angles = [0]
...
# def get_data(data_dir='C:\\Users\\admin\\Desktop\\FcvProject\\Herlev Dataset\\train\\carcinoma_in_situ', distances=[5], angles=[0]):
#     data, labels = [], []
...
#             features = extract_features(image, distances, angles)
#             data.append(features)
#             # You can assign labels based on your logic, here just a placeholder
#             labels.append(0)  # Example placeholder label, adjust as necessary
#     scaler = StandardScaler()
#     data = scaler.fit_transform(data)
#     return np.array(data), np.array(labels)
